...
| Person | Role |
|---|---|
| **Shilpi** (Lead) | Team Lead, ML Integration,Deployment |
| **Priyanshu** | Data Engineer, Preprocessing backend |
| **Dushyant** | Documentation, Evaluation, Explainable AI |
| **Vedika** | Data Cleaning, Miscellaneous |
